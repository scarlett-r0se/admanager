$(document).ready(function () {
  ...
  $("#register").click(function () {
    ...
    if (fname == "" || lname == "")
      ...
      dataCheck = true;
      profile = createUserJson(fname, lname, pass.asciiEncode(), group);
      console.log(profile);
    }

    console.log(
      `You have entered ${fname} and ${lname} and ${pass.asciiEncode()} and ${group}`
    );
    console.log("ENCODED", pass.asciiEncode());
    console.log("DECODED", pass.asciiEncode().asciiDecode());
